...
\begin{itemize}
    ...
    \item \textbf{Traseu static:} Deși generat procedural, traseul are o formă fixă (octogon). Nu există variabilitate în topologia circuitului între sesiuni de joc.
