...
\begin{itemize}
    ...
    \item \textbf{Generarea procedurală a traseului:} Construcția algoritmică a unui circuit de curse în formă de octogon regulat, complet cu segmente de drum, pereți interiori și exteriori, și texturi procedurale.
