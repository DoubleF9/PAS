...
\begin{itemize}
    ...
    \item \textbf{Generare procedurală avansată:} Extinderea algoritmului de generare pentru a crea trasee variate (serpentine, intersecții, diferențe de altitudine) folosind curbe Bézier sau spline-uri.
